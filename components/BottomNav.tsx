...
const BottomNav: React.FC<BottomNavProps> = ({ currentScreen, onNavigate }) => {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 w-[90%] max-w-[380px] bg-white/90 backdrop-blur-xl rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] border border-white/50 p-2 z-40">
